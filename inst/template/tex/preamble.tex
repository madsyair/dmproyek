% ============================================================
%  Preamble format Laporan Proyek Data Mining Politeknik Statistika STIS
%  Mengikuti konvensi penulisan laporan akademik Politeknik Statistika STIS
...
%     pustaka). TEKS ISI (Bab I dst.) diset 2 spasi sesuai konvensi penulisan
...
% --- Dukungan tabel sesuai konvensi ---
...
%   atau putar ke landscape. Jangan memperkecil huruf < 8 pt (konvensi).
...
%     sesuai konvensi penulisan. Karena itu counter chapter dibiarkan Arab,
%     dan Romawi hanya ditampilkan pada JUDUL bab.
\usepackage{titlesec}
\renewcommand{\chaptername}{BAB}
% Judul bab/subbab diketik 1 spasi (konvensi): bungkus dengan \singlespacing.
\titleformat{\chapter}[display]
  {\normalfont\bfseries\centering\singlespacing}
  {\MakeUppercase{\chaptername}\ \Roman{chapter}}{0pt}
  {\MakeUppercase}
% Jarak judul bab ke teks/subbab di bawahnya ~3-4 spasi (lihat konvensi penulisan)
\titlespacing*{\chapter}{0pt}{0pt}{2\baselineskip}
\titleformat{\section}{\normalfont\bfseries\singlespacing}{\thesection}{1em}{}
\titleformat{\subsection}{\normalfont\bfseries\singlespacing}{\thesubsection}{1em}{}
% Judul level ke-4 (####) tidak bernomor (number-depth:3) -> cukup TEBAL (konvensi
% hlm. 35), tanpa miring.
\titleformat{\subsubsection}{\normalfont\bfseries\singlespacing}{\thesubsubsection}{1em}{}
% Jarak sub bab dengan teks ~3 spasi (konvensi penulisan). Di bawah \doublespacing
...
%     TUNGGAL berjalan di seluruh laporan (Tabel 1, 2, 3, ...; Gambar 1, 2, ...;
%     persamaan (1), (2), ...) sesuai konvensi penulisan & 8 (bukan per-bab 4.1).
...
%     Judul tabel/gambar yang lebih dari satu baris diketik 1 spasi (konvensi). ---
\usepackage{caption}
...
% --- Tata letak float (konvensi): tabel/gambar SELALU rata tengah dan berjarak
...
%     bagian isi   -> angka Arab, di KANAN bawah (konvensi penulisan), berlaku pada
...
\fancypagestyle{isistis}{%
  ...
  \fancyfoot[R]{\thepage}%  bagian isi: angka Arab di tepi kanan bawah (konvensi penulisan)
}
...
%     sesuai konvensi konvensi. Mendefinisikan ulang \cleardoublepage. ---
...
% dengan tabel/gambar/persamaan. (konvensi penulisan)
